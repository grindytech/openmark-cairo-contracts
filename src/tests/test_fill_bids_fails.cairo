...
fn fill_bids_asking_price_too_high_panics() {
    ...
    start_cheat_caller_address(openmark_address, seller);
    start_cheat_caller_address(eth_address, openmark_address);
    OpenMarkDispatcher.fill_bids(signed_bids, erc721_address, tokenIds, unitPrice + 1);
}
...
fn fill_bids_nft_mismatch_panics() {
    ...
    start_cheat_caller_address(openmark_address, seller);
    start_cheat_caller_address(eth_address, openmark_address);
    OpenMarkDispatcher.fill_bids(signed_bids, 1.try_into().unwrap(), tokenIds, unitPrice);
}
...
fn fill_bids_exceed_bid_nfts_panics() {
    ...
    OpenMarkDispatcher.fill_bids(signed_bids, erc721_address, new_tokenIds.span(), unitPrice);
}
